...
const HeroSection = () => {
  return (
    <div className="container mx-auto p-20 bg-red" >
      <div className="">
        <h1 className="text-xl md:text-2xl font-thin text-center px-4 uppercase">
          Vivi la natura
        </h1>
        <h3 className='text-xl md:text-2xl text-center px-4'>Cura nei dettagli e sostenibilità</h3>
